...
public class FacilityBookingDashbordActivity extends BaseActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.menu_facility_booking,menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(item.getItemId()==R.id.action_prev_booking_list){

            Intent intent = new Intent(getActivity(),FacilitybookingListActivity.class);
            intent.putExtra(Constants.FROM_BOOKING_TYPE,0);
            startActivity(intent);
        }

        if(item.getItemId()==R.id.action_upcoming_booking_list){

            Intent intent = new Intent(getActivity(),FacilitybookingListActivity.class);
            intent.putExtra(Constants.FROM_BOOKING_TYPE,1);
            startActivity(intent);
        }
