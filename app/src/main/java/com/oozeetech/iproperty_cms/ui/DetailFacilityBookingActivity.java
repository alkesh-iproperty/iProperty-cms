        ...
        public void onSuccess(String response) {
            ...
            try {
                ...
                if (response != null && response.length() > 0) {
                    ...
                    FacilityBookingResponse res = new Gson().fromJson(
                            response, new TypeToken<FacilityBookingResponse>() {
                            }.getType());

                    if (res.st == 1) {

                        showToast(R.string.msg_success_booking, Toast.LENGTH_SHORT);
                    }
