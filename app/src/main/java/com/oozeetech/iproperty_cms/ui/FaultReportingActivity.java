...
public class FaultReportingActivity extends BaseActivity {
    ...
    public void sendFaultReport(){
        ...
        try {
            ...
            clientPhotos.get(new URLs().ADD_FAULT, params, new AllFaultsHandler(getActivity()));
    ...
    public void uploadImage(Bitmap bitmap){
        ...
        RequestParams params = new RequestParams();
        params.put("upload",  new ByteArrayInputStream(byteArray));
        AsyncHttpClient client = new AsyncHttpClient();
        client.post(getActivity(),new URLs().FAULT_UPLOAD,params,new ImageUploadHandler(getActivity()));

    }

    private class ImageUploadHandler extends AsyncResponseHandler {

        public ImageUploadHandler(Activity context) {
            super(context);
        }
        ...
        public void onSuccess(String response) {
            ...
            try {
                Debug.e("", "FaultReportResponse# " + response);
                if (response != null && response.length() > 0) {
