 ...
 */
public class MaintananceListAdapter extends RecyclerView.Adapter<MaintananceListAdapter.ImpNoHolder> {

    Context context;
    private List<MaintanancePaymentResponse.Hisory> data = new ArrayList<>();

    private EventListener mEventListener;
    private View.OnClickListener mItemViewOnClickListener;


    public MaintananceListAdapter(Context context) {
    ...
    public void addAll(List<MaintanancePaymentResponse.Hisory> mData) {
    ...
    public MaintanancePaymentResponse.Hisory getItem(int position) {
