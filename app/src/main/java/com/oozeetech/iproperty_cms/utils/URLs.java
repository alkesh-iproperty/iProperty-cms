...
public class URLs {
    ...
    public final String EVENT_IMG_URL = MAIN_URL+"/upload/event/";
    public final String SLIDING_IMAGES = MAIN_URL+"/upload/facility/";
    public final String FAULT_UPLOAD = MAIN_URL+"/upload/fault/";
    public final String GELLERY_IMG_URL = MAIN_URL+"/upload/gallery/";
    public final String GALLERY_ITEMS_IMG_URL = MAIN_URL+"/upload/galleryitem/";
